...
def product_selector():
    ...
    if func_type=='Single Functional Products':
        ...
        if alk_booster == 'Yes':
            ...
            if (sl == 'Solid') and (opco in ['USA','Canada', 'LATAM', 'RSA']) and (op_pres=='Between 10 to 60 Bar') and (fda == 'Yes') and (dairy == 'both'):
                alk_dict['selected'] = 'Yes'
                alk_dict['product'] = ['Impackt BW ALK']
            elif (sl == 'Liquid')  and (opco in ['Canada','USA']) and (op_pres=='Between 10 to 60 Bar') and (fda == 'Yes') and (dairy == 'both'):
                alk_dict['selected'] = 'Yes'
